...
class PlanoDestaque(models.TextChoices):
    NORMAL = "normal", "Normal"
    DESTAQUE = "destaque", "Destaque"
    DESTAQUE_PLUS = "destaque-plus", "Destaque Plus"
    PREMIUM = "premium", "Premium"


PRECO_POR_PLANO = {
    PlanoDestaque.DESTAQUE: Decimal("19.90"),
    PlanoDestaque.DESTAQUE_PLUS: Decimal("39.90"),
    PlanoDestaque.PREMIUM: Decimal("79.90"),
}

RANK_POR_PLANO = {
    PlanoDestaque.NORMAL: 0,
    PlanoDestaque.DESTAQUE: 1,
    PlanoDestaque.DESTAQUE_PLUS: 2,
    PlanoDestaque.PREMIUM: 3,
}

DIAS_DESTAQUE_PADRAO = 30

BENEFICIOS_POR_PLANO = {
    PlanoDestaque.DESTAQUE: "Aparece em posição privilegiada nas listas de categoria e região.",
    PlanoDestaque.DESTAQUE_PLUS: "Tudo do Destaque, mais prioridade para entrar no carrossel da home.",
    PlanoDestaque.PREMIUM: "Tudo do Destaque Plus, com a maior prioridade de exposição do site.",
}
