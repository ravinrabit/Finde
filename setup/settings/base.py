...
if _DATABASE_URL:
    from .database_url import config_de_database_url

    DATABASES = {"default": config_de_database_url(_DATABASE_URL)}
...
RAZAO_SOCIAL = config("RAZAO_SOCIAL", default="[PREENCHER: razão social ou nome do responsável]")
CNPJ = config("CNPJ", default="[PREENCHER: CNPJ ou CPF do responsável, se ainda não houver empresa]")
ENDERECO_COMERCIAL = config("ENDERECO_COMERCIAL", default="[PREENCHER: endereço para correspondência]")
...
# =========================
# GEOCODIFICAÇÃO E BUSCA EXTERNA
# =========================
...
IA_MODELO = config("IA_MODELO", default="llama3.2")
